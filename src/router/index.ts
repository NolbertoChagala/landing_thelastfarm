...
<head>
    ...
    <title>Bienvenido a Stardew Valley Clone</title>
</head>
<body>
    <header>
        <h1>Bienvenido a Stardew Valley Clone</h1>
    ...
    <section id="features">
        ...
        <div class="feature">
            ...
            <p>Construye tu hogar y personalízalo a tu gusto con muebles y decoraciones.</p>
        </div>
    </section>

    <footer>
        <p>&copy; 2023 Stardew Valley Clone. Todos los derechos reservados.</p>
    </footer>
</body>
</html>